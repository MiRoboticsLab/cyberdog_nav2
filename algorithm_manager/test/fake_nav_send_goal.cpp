...
class FakeNavSendGoal : public rclcpp::Node
{
public:
  FakeNavSendGoal() : rclcpp::Node("fake_nav_send_goal_action")
  {
    nav_action_ = rclcpp_action::create_server<mcr_msgs::action::TargetTracking>(
...
private:
  ...
  rclcpp_action::Server<mcr_msgs::action::TargetTracking>::SharedPtr nav_action_;
