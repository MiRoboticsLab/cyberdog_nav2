...
#ifndef CYBERDOG_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_CLIENT_HPP_
#define CYBERDOG_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_CLIENT_HPP_

#include <memory>
#include <string>

#include "geometry_msgs/msg/pose_with_covariance_stamped.hpp"
#include "cyberdog_lifecycle_msgs/srv/manage_lifecycle_nodes.hpp"
#include "std_srvs/srv/empty.hpp"
#include "std_srvs/srv/trigger.hpp"
#include "cyberdog_lifecycle/service_client.hpp"
...
protected:
  using ManageLifecycleNodes = cyberdog_lifecycle_msgs::srv::ManageLifecycleNodes;
  ...
  std::shared_ptr<lifecycle::ServiceClient<ManageLifecycleNodes>> manager_client_;
  std::shared_ptr<lifecycle::ServiceClient<std_srvs::srv::Trigger>> is_active_client_;
...
#endif  // CYBERDOG_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_CLIENT_HPP_
