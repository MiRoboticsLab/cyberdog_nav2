...
#ifndef CYBERDOG_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
#define CYBERDOG_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
...
#include "cyberdog_lifecycle/lifecycle_service_client.hpp"
#include "cyberdog_lifecycle_msgs/srv/manage_lifecycle_nodes.hpp"
#include "cyberdog_lifecycle/node_thread.hpp"
...
using cyberdog_lifecycle_msgs::srv::ManageLifecycleNodes;
/**
...
protected:
  ...
  std::unique_ptr<lifecycle::NodeThread> service_thread_;
  ...
  std::map<std::string, std::shared_ptr<lifecycle::LifecycleServiceClient>> node_map_;
...
#endif  // CYBERDOG_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
