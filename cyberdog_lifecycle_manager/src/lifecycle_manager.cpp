...
#include "cyberdog_lifecycle_manager/lifecycle_manager.hpp"
...
using cyberdog::lifecycle::LifecycleServiceClient;
...
: Node("lifecycle_manager")
{
  ...
  service_thread_ = std::make_unique<lifecycle::NodeThread>(executor);
}
