...
#ifndef CYBERDOG_LIFECYCLE__LIFECYCLE_NODE_HPP_
#define CYBERDOG_LIFECYCLE__LIFECYCLE_NODE_HPP_
...
public:
   ...
   */
  std::shared_ptr<cyberdog::lifecycle::LifecycleNode> shared_from_this()
  {
    return std::static_pointer_cast<cyberdog::lifecycle::LifecycleNode>(
   ...
   */
  cyberdog::lifecycle::CallbackReturn on_error(const rclcpp_lifecycle::State & /*state*/)
  {
    RCLCPP_FATAL(
      get_logger(),
      "Lifecycle node %s does not have error state implemented", get_name());
    return cyberdog::lifecycle::CallbackReturn::SUCCESS;
  }
...
#endif  // CYBERDOG_LIFECYCLE__LIFECYCLE_NODE_HPP_
