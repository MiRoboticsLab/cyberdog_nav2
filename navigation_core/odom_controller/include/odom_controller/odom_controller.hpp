...
#ifndef ODOM_CONTROLLER__ODOM_CONTROLLER_HPP_
#define ODOM_CONTROLLER__ODOM_CONTROLLER_HPP_
...
{
class OdomController : public nav2_util::LifecycleNode
{
public:
  OdomController();
  ~OdomController();
...
#endif  // ODOM_CONTROLLER__ODOM_CONTROLLER_HPP_
